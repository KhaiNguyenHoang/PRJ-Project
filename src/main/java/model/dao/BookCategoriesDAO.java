...
public class BookCategoriesDAO extends LibraryContext {
    ...
    public static void main(String[] args) {
        BookCategoriesDAO dao = new BookCategoriesDAO();
        dao.addBookCategory(new BookCategories("Fiction"));
        List<BookCategories> categories = dao.getAllBookCategories();
        for (BookCategories category : categories) {
            System.out.println(category.getIdCategory() + " - " + category.getCategoryName());
        }
    }

                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
                        <ul class="navbar-nav  ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#how_section layout_padding"> How </a>
                            </li>
                            <li class="nav-item">
...
<!-- how section -->
<section class="how_section layout_padding" id="how_section layout_padding">
    ...
    <div class="how_container">
        <div class="box">
            <div class="img-box">
                <svg height="512" id="Capa_1"
                     style="enable-background:new 0 0 512 512;"
                     version="1.1" viewBox="0 0 512 512" width="512" x="0px"
                     xml:space="preserve"
            ...
            <div class="detail-box">
                ...
                <p>
                    Find the book by Author and Name.
                </p>
            </div>
        </div>
        <div class="box">
            <div class="img-box">
                <svg enable-background="new 0 0 510 510" height="512" id="Capa_1" viewBox="0 0 510 510" width="512"
            ...
            <div class="detail-box">
                ...
                <p>
                    Online borrowing the book, easy to use.
                </p>
            </div>
        </div>
        <div class="box">
...
<section class="about_section layout_padding-bottom" id="about_section">
    <div class="container">
        <div class="heading_container">
            <h2>
                About Book Reading Advantaged
            </h2>
        </div>
        <div class="box">
            <div class="detail-box">
                <p>
                    Reading books is one of the most beneficial habits you can cultivate. It helps to improve your
                    concentration,
                    stimulates creativity, and enhances your knowledge. Whether you're reading for pleasure or for
                    educational
                    purposes,
                    books allow you to learn new ideas, explore different perspectives, and gain a deeper understanding
                    of the
                    world around you.
                    Additionally, reading can help you reduce stress, improve your vocabulary, and even boost your
                    mental health
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="b-1">
                <div class="client_id">
                    <div class="img-box">
                        <img alt="Client 1" src="HomeHTML/HomeMemberHTML/images/client-1.jpg">
                    </div>
                    <div class="name">
                        <h5>John Doe</h5>
            ...
            <div class="client_detail">
                <p>
                    "I absolutely love reading! The books I've read have expanded my mind in ways I never thought
                    possible. I
                    highly recommend reading as a hobby!"
                </p>
            </div>
        </div>
        ...
        <div class="box">
            <div class="client_id">
                <div class="img-box">
                    <img alt="Client 2" src="HomeHTML/HomeMemberHTML/images/client-2.jpg">
                </div>
                <div class="name">
                    <h5>Jane Smith</h5>
                    <h6>Author</h6>
            ...
            <div class="client_detail">
                <p>
                    "Reading is an essential part of personal development. It allows you to grow and understand
                    different
                    perspectives. I believe books can change your life!"
                </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <span>
                  Reading Books
                    ...
                    <div>
                        <div class="img-box">
                            <img alt="Location Icon" src="HomeHTML/HomeMemberHTML/images/location.png" width="18px"/>
                        </div>
                        <p>
                            FPT Universite, Can Tho Campus, Can Tho City, Vietnam
                        </p>
                    </div>
                    <div>
                        <div class="img-box">
                            <img alt="Phone Icon" src="HomeHTML/HomeMemberHTML/images/phone.png" width="18px"/>
                        </div>
                        <p>
                            +036 2975527
                        </p>
                    ...
                    <div>
                        <div class="img-box">
                            <img alt="Email Icon" src="HomeHTML/HomeMemberHTML/images/envelope.png" width="18px"/>
                        </div>
                        <p>
                            contact@readingbooks.com
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="info_info">
                    ...
                    <p>
                        Reading books enhances knowledge, improves concentration, reduces stress, and boosts creativity.
                        It's a powerful tool for personal growth and mental well-being.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="info_form">
                    ...
                    <p>
                        Subscribe to our newsletter to get updates on the latest book reviews, reading challenges, and
                        book-related events.
                    </p>
                    <form action="">
...
<section class="container-fluid footer_section">
    <p>
        &copy; 2024 Group 2 All Rights Reserved | Design by Group 2
    </p>
</section>
<!-- footer section -->

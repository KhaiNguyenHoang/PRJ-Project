...
<%@ page import="model.BorrowingHistory" %>
<%@ page import="dao.BookDetailDAO" %>
<%@ page import="dao.BookCopiesDAO" %>
...
<%
    ...
    List<BorrowingHistory> borrowingList = (List<BorrowingHistory>) request.getAttribute("borrowingList");
%>
            ...
            <div class="table-container">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><%= borrowing.getBorrowDate() != null ? sdf.format(borrowing.getBorrowDate()) : "N/A" %>
                        </td>
                        <td><%= borrowing.getReturnDate() != null ? sdf.format(borrowing.getReturnDate()) : "Not Returned" %>
                        </td>
                        <td><%= borrowing.getReturnDate() != null ? "Returned" : "Borrowed" %>
                        </td>
                    </tr>
                    <% } %>
                    <% } else { %>
